...
export default function VendorPayoutsPage() {
  ...
  const filtered = payouts.filter((p) =>
    [p.vendorName, p.city, p.payoutMethod, p.status, p.id]
      .join(" ")
      .toLowerCase()
  ...
  function approve(id: string) {
    ...
    if (selected?.id === id)
      setSelected({ ...(selected as Payout), status: "Completed" });
  }
  ...
  function reject(id: string) {
    ...
    if (selected?.id === id)
      setSelected({ ...(selected as Payout), status: "Rejected" });
  }
                    ...
                    >
                      <TableCell className="pl-6">
                        <div className="flex items-center gap-3">
                          <Avatar>
                            <AvatarImage
                              src={`/images/vendors/${p.vendorId}.jpg`}
                              alt={p.vendorName}
                            />
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <Avatar className="w-16 h-16">
                  <AvatarImage
                    src={`/images/vendors/${selected.vendorId}.jpg`}
                    alt={selected.vendorName}
                  />
