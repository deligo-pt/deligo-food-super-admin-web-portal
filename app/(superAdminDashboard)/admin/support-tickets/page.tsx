...
const MOCK: Ticket[] = [
  {
    ...
    priority: "high",
    messages: [
      { from: "Ana Costa", body: "My order didn’t arrive.", at: "2025-11-20T10:25:00.000Z" },
    ],
  },
  {
    id: "TCK-0002",
    ...
    priority: "medium",
    messages: [
      { from: "Miguel", body: "I see two charges.", at: "2025-11-19T08:15:00.000Z" },
    ],
  },
  {
    id: "TCK-0003",
    ...
    priority: "low",
    messages: [
      { from: "Joana", body: "Crash on upload.", at: "2025-11-18T12:45:00.000Z" },
    ],
  },
];
...
export default function SupportTicketsCardGrid() {
  ...
  const filtered = tickets.filter((t) =>
    [t.subject, t.user, t.id].join(" ").toLowerCase().includes(query.toLowerCase())
  );
  ...
  function sendReply() {
    ...
    drawer.messages.push({ from: "Support", body: text, at: new Date().toISOString() });
        ...
        {filtered.map((t) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <span className={`px-3 py-1 text-xs rounded-full ${STATUS[t.status]}`}>
                {t.status.replace("_", " ")}
              </span>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-end z-50">
          <div className="w-full sm:w-[420px] h-full bg-white rounded-l-3xl p-6 flex flex-col shadow-xl animate-slide-in">
            ...
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-xl font-semibold w-10/12 leading-tight">{drawer.subject}</h2>
              <button
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-medium">{drawer.user}</p>
                <p className="text-xs text-gray-500">{drawer.userEmail}</p>
              </div>
            </div>
