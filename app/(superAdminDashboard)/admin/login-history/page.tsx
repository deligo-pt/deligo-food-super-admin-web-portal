    ...
    <div className="min-h-screen bg-linear-to-b from-white via-gray-50 to-gray-100">
      <div className="">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <button
            onClick={exportCSV}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#DC3173] text-white shadow hover:brightness-95"
          >
            ...
            <div className="p-6">
              <div className="space-y-6">
                {visible.map((r, i) => (
                  ...
                  >
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-3 h-3 rounded-full ${r.status === "success" ? "bg-green-500" : "bg-red-500"}`}
                      />
                    ...
                    <div className="flex-1 bg-gray-50 rounded-xl p-4 shadow-sm">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          ...
                          <div className="text-sm text-gray-600 mt-1">
                            {r.action ??
                              `${r.status === "success" ? "Signed in" : "Failed login attempt"}`}
                          </div>
                        </div>
                      ...
                      <div className="mt-3 flex items-center gap-3 flex-wrap">
                        ...
                        <div className="ml-auto flex items-center gap-2">
                          <button
                            onClick={() => revokeSession(r.id)}
                            className="flex items-center gap-2 px-3 py-1 rounded-md bg-red-50 text-red-700 border"
                          >
                ...
                <div className="pt-4 flex items-center justify-center">
                  ...
                  <div className="px-3 py-1 rounded-md bg-gray-50 border">
                    {page} / {totalPages}
                  </div>
                  <button
            ...
            <div className="overflow-x-auto">
                    ...
                    >
                      ...
                      <td className="p-3">
                        ...
                        <div className="text-xs text-gray-400">
                          {secToH(r.durationSec)}
                        </div>
                      </td>
                      <td className="p-3">
                        {r.status === "success" ? (
                          <span className="inline-flex items-center gap-2 px-2 py-1 rounded-full bg-green-50 text-green-700">
                            <CheckCircle size={14} /> {t("success")}
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-2 px-2 py-1 rounded-full bg-red-50 text-red-700">
                      ...
                      <td className="p-3 text-right">
                        <div className="flex items-center gap-2 justify-end">
                          ...
                          <button
                            onClick={() =>
                              alert("Show more details - implement modal")
                            }
                            className="px-3 py-1 rounded-md bg-[#DC3173] text-white"
                          >
                            {t("details")}
                          </button>
                        </div>
              ...
              <div className="p-4 border-t flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  ...
                  {Math.min(page * perPage, filtered.length)} {t("of")}{" "}
                  {filtered.length}
                </div>
                <div className="flex items-center gap-2">
                  <button
