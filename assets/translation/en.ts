...
export const en = {
    ...
    // business-info
    real_time_overview_deligo_performance: "Real-time overview of DeliGo&lsquo;s performance",
    ...
    this_font_will_be_applied_all_customer: "This font will be applied to all customer, vendor, and partner apps.",
    ...
    // global settings
    manage_your_platform_core_configuration: "Manage your platform's core configuration and rules",
    saving: "Saving...",
    saved: "Saved!",
    platform_status: "Platform Status",
    your_platform_currently_live: "Your platform is currently live and accepting orders.",
    platform_maintenance_mode: "Platform is in maintenance mode. No orders can be placed.",
    maintenance_message: "Maintenance Message",
    enter_message_shown_to_users: "Enter message shown to users...",
    delivery_pricing: "Delivery Pricing",
    configure_base_rates_distance: "Configure base rates and distance calculations",
    ...
    percentage_taken_from_each_order_total: "Percentage taken from each order total",
    ...
    define_constraints_for_customer_orders: "Define constraints for customer orders",
    ...
    time_widow_customers_cancel: "Time window for customers to cancel without penalty",
    refund_processing_days: "Refund Processing Days",
    otp_security: "OTP & Security",
    configure_order_verification_settings: "Configure order verification settings",
    enable_order_otp: "Enable Order OTP",
    require_otp_verification_order_delivery: "Require OTP verification for order delivery",
