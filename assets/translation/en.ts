export const en = {
  ...
  establishment_a_z: "Establishment (A-Z)",
  tax_name_a_z: "Tax Name (A-Z)",
  tax_name_z_a: "Tax Name (Z-A)",
  // filtering
  searching: "Search...",
  sort_by: "Sort By",
  status: "Status",
  ...
  download: "Download",
  no_agreement_found: "No agreement document available.",
  signed_agreement_description: "Official signed partnership agreement PDF.",
  ...
  company_legal_name_description: "Company Legal Name and Business/Brand Name can be same",
  ...
  you_can_proceed_to_the_next_step_to_sign: "You can proceed to the next step to sign the agreement.",
  create_vendor_agreement: "Create Vendor Agreement",
  ...
  partyRepresentativeRole: "Party Representative Role",
  partyRepresentativeRolePH: "e.g. Gerente Geral",
  agreement_sign: "Sign Agreement",
  review_nd_sign_the_agreement: "Review and sign the agreement below. After signing, you can submit the vendor.",
  agreement_signed_successfully: "Agreement signed successfully",
  click_submit_vendor_below: "Click Submit Vendor below to finish.",
  previous: "Previous",
  step_lg: "Step",
  continue_to_agreements: "Continue to Agreements",
  ...
  set_agreements_related_urls_nd_infos: "Set Agreements related urls and infos",
  deligo_signatory_name: "DeliGo Signatory Name",
  deligo_signatory_name_for_agreement: "DeliGo Signatory Name for agreement",
  deligo_signatory_role: "DeliGo Signatory Role",
  deligo_signatory_role_in_agreement: "DeliGo signatory role in the agreement",
  deligo_signature_url: "DeliGo Signature URL",
  deligo_company_stamp_url: "DeliGo Company Stamp URL",
  uploaded_successfully: "Uploaded Succeessfully",
  uploading: "Uploading...",
  click_to_upload: "Click to Upload",
  activity_log_retention: "Activity Log Retention",
  control_activity_logs_nd_customize: "Control activity logs and customize",
  archive_after_months: "Archive After Months",
  months_after_which_an_activityLogArchive: "Months after which an ActivityLog document is moved to ActivityLogArchive.",
  permanently_delete_after_month: "Permanently Delete After Month",
  months_after_which_archived: "Months after which an archived record is permanently deleted.",
  maximum_documents_per_batch: "Maximum Documents Per Batch",
  max_documents_the_retention_job: "Max documents the retention job processes per batch.",
