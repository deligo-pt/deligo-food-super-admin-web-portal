export const pt = {
  ...
  agreement_document: "Documento do Acordo",
  download: "Descarregar",
  no_agreement_found: "Nenhum documento de acordo disponível.",
  signed_agreement_description: "PDF oficial do acordo de parceria assinado.",
  agreement_preview: "Pré-visualização do Acordo",
  ...
  // add-ons page
  inc_vat: "Com IVA",
  no_options_added: "Ainda não foram adicionadas opções a este grupo.",
  no_addon_groups_found: "Nenhum grupo de extras encontrado.",
  add_ons_extras: "Complementos e Extras",
  manage_your_add_on_groups_options: "Gerir os seus grupos de extras e opções",
  add_addon_to: "Adicionar Extra a",
  ...
  addon_group: "Grupo de Extras",
  group_title: "Título do Grupo",
  min_select: "Seleção Mínima",
  max_select: "Seleção Máxima",
  option_name: "Nome da Opção",
  add_an_option_name: "Adicionar nome da opção",
  options: "Opções",
  option_price: "Preço da Opção",
  select_tax: "Selecionar Taxa de Imposto",
  add_option: "Adicionar Opção",
  is_active: "Estado Ativo",
  save_category: "Guardar Categoria",
  update_existing_product_category: "Atualizar categoria de produto existente",
  update_category: "Atualizar Categoria",
  deleting_option: "A eliminar opção...",
  updating_status: "A atualizar estado...",
  // add-new-item page
  add_new_item: "Adicionar Novo Item",
  fill_the_details_to_add_new_food_item:
    "Preencha os detalhes para adicionar um novo item alimentar ao seu menu.",
  basic_information: "Informação Básica",
  product_name: "Nome do Produto",
  product_name_placeholder: "ex.: Pizza BBQ",
  ...
  choose_add_on: "Escolher Extra",
  add_an_option_price: "Adicionar preço da opção",
  stock_quantity: "Quantidade em Stock",
  add_stock_quantity: "Adicionar quantidade em stock",
  select_discount_type: "Selecionar Tipo de Desconto",
  select_category_placeholder: "Selecionar uma categoria",
  select_additional_categories: "Selecionar categorias adicionais",
  select_language_placeholder: "Selecionar um idioma",
  ...
  file_size_limit: "O ficheiro deve ter menos de 5MB",
  image_upload_success: "Imagem carregada com sucesso!",
  image_upload_fail: "Falha ao carregar imagem",
  image_delete_success: "Imagem eliminada com sucesso!",
  image_delete_fail: "Falha ao eliminar imagem",
  generate_description_hint: "Sugestão para gerar descrição",
  ai_generate_description: "Gerar descrição com IA",
  enter_product_description: "Introduza a descrição do produto",
  ...
  incl: "incl.",
  price_tax_breakdown: "Detalhamento de Preço e Impostos",
  customer_order_price: "Preço do Pedido do Cliente",
  incl_vat: "Com IVA",
  net_item_price: "Preço Líquido do Item",
  govt_vat: "IVA Estatal",
  final_price: "Preço Final",
  base_price: "Preço Base",
  add_ons_and_variants: "Complementos e Variantes",
  add_variation: "Adicionar Variante",
  quantity: "Quantidade",
  unit: "Unidade",
  add_ons: "Extras",
  deligo_metadata: "Metadados Deligo",
  deligo_metadata_information: "Informação de Metadados Deligo",
  ...
  base: "Base",
  final: "Final",
  manage_your_restaurants_food_delivery_items: "Gira o catálogo de entregas do seu restaurante",
  ...
  create_agreement: "Criar Acordo",
  agreement_created_successfully: "Acordo criado com sucesso",
  you_can_proceed_to_the_next_step_to_sign: "Pode prosseguir para o passo seguinte para assinar o acordo.",
  create_vendor_agreement: "Criar Acordo de Fornecedor",
  ...
  partyRepresentativeRole: "Cargo do Representante da Parte",
  partyRepresentativeRolePH: "ex.: Gerente Geral",
  agreement_sign: "Assinar Acordo",
  review_nd_sign_the_agreement: "Reveja e assine o acordo abaixo. Após assinar, pode submeter o fornecedor.",
  agreement_signed_successfully: "Acordo assinado com sucesso",
  click_submit_vendor_below: "Clique em Submeter Fornecedor abaixo para concluir.",
  previous: "Anterior",
  step_lg: "Passo",
  continue_to_agreements: "Continuar para Acordos",
  ...
  overview_revenue_orders_business_performance: "Visão geral de receita, pedidos e desempenho do negócio",
  ...
  revenue_trend_over_months: "Tendência de receita ao longo dos meses",
  daily_orders: "Pedidos Diários",
  orders_distribution_over_last_7_days: "Distribuição de pedidos nos últimos 7 dias",
  order_status: "Status do Pedido",
  payment_methods: "Métodos de Pagamento",
  revenue_by_location: "Receita por Localização",
  revenue_by_vendor: "Receita por Vendedor",
  ...
  // customer-insights
  understand_user_behaviour_and_engagement: "Entenda o comportamento e o engajamento do usuário",
  ...
  peak_order_time: "Horário de Pico de Pedidos",
  order_frequency: "Frequência de Pedidos",
  active_users: "Usuários Ativos",
  top_customers: "Melhores Clientes",

  // top-vendors
  vendor_ranking_and_performance_insights: "Classificação de vendedores e informações de desempenho",
  top_vendor: "Melhor Vendedor",
  avg_cancel_rate: "Taxa Média de Cancelamento",
  top_selling_vendors: "Vendedores que Mais Vendem",
  revenue_and_volume_leaders: "Líderes de receita e volume",
  revenue_by_top_vendors: "Receita dos Melhores Vendedores",
  vendor_performance: "Desempenho do Vendedor",
  deep_dive_into_operational_efficiency: "Análise detalhada da eficiência operacional e qualidade",
  avg_prep: "Tempo Médio de Prep.",
  satisfaction: "Satisfação",
  cancellation: "Cancelamento",
  rating_distribution: "Distribuição de Avaliações",
  total_volume_acroos: "Volume total em",
  vendor_quality: "Qualidade do Vendedor",
  ...
  understand_demand_patterns_optimize_operations: "Entenda os padrões de demanda e otimize as operações",
  ...
  send_announcements_alerts_promotional_emails: "Envie comunicados, alertas ou mensagens promocionais para grupos de usuários específicos em toda a plataforma.",
  communication_type: "Tipo de Comunicação",
  target_audience: "Público-Alvo",
  select_specific: "Selecionar Específicos",
  users: "usuários",
  ...
  always_check_preview_before_broadcasting: "Sempre verifique a pré-visualização antes de transmitir.",
  use_personalization_tags: "Use tags de personalização como",
  if_supported: "se houver suporte.",
  ...
  set_agreements_related_urls_nd_infos: "Definir URLs e informações relativas a acordos",
  deligo_signatory_name: "Nome do Signatário DeliGo",
  deligo_signatory_name_for_agreement: "Nome do signatário DeliGo para o acordo",
  deligo_signatory_role: "Cargo do Signatário DeliGo",
  deligo_signatory_role_in_agreement: "Cargo do signatário DeliGo no acordo",
  deligo_signature_url: "URL da Assinatura DeliGo",
  deligo_company_stamp_url: "URL do Carimbo da Empresa DeliGo",
  uploaded_successfully: "Carregado com sucesso",
  uploading: "A carregar...",
  click_to_upload: "Clique para carregar",
  activity_log_retention: "Retenção do Registo de Atividade",
  control_activity_logs_nd_customize: "Controlar e personalizar registos de atividade",
  archive_after_months: "Arquivar Após Meses",
  months_after_which_an_activityLogArchive: "Meses após os quais um documento de ActivityLog é movido para o ActivityLogArchive.",
  permanently_delete_after_month: "Eliminar Permanentemente Após Meses",
  months_after_which_archived: "Meses após os quais um registo arquivado é eliminado permanentemente.",
  maximum_documents_per_batch: "Máximo de Documentos Por Lote",
  max_documents_the_retention_job: "Número máximo de documentos que o processo de retenção processa por lote.",
