...
interface GetFleetManagerWalletColumnsParams {
    t: TFunction;
    router: AppRouterInstance;
}

export function getFleetManagerWalletColumns({
    t,
    router,
}: GetFleetManagerWalletColumnsParams): Column<TFleetManagerWallet>[] {
    return [
        {
            header: (
            ...
            accessor: (w) => (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem
                            onClick={() =>
                                router.push(`/admin/fleet-manager-wallets/${w.walletId}`)
                            }
                        >
                            {t("view")}
                        </DropdownMenuItem>
